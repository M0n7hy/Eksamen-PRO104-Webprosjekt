const pizzaMenu = (function() {
    ...
    const pizzaArray = [
        { id: 0, name:"Classic Margarita", price: 120, profit:60, img:"Margarita.png", allergies: "Gulten, Milk"},
        { id: 1, name:"Pepperoni Pizza", price: 140, profit:70, img:"Pepperoni.png", allergies:"Gluten, Milk"},
        { id: 2, name:"Kebab Pizza", price: 150, profit:75, img:"Kebab.png", allergies:"Gluten, Milk"},
        { id: 3, name:"Taco Pizza", price:150, profit:70, img:"Tacopizza.png", allergies:"Gluten, Milk"},
        { id: 4, name:"Pizza Parma", price:135, profit:80, img:"Parma.png", allergies:"Gluten, Milk"},
        { id: 5, name:"Pizza Pollo", price:145, profit:70, img:"Pollo.png", allergies:"Gluten, Milk"},
        { id: 6, name:"Beef Pizza", price:155, profit:65, img:"Biffpizza.png", allergies:"Gluten, Milk"},
        { id: 7, name:"Cheddar Dream", price:130, profit:85, img:"Cheddar.png", allergies:"Gluten, Milk"},
